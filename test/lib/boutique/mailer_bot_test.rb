...
class Boutique::MailerBotTest < ActiveSupport::TestCase
  ...
  test "subscriptions_for_unpaid" do
    ...
    target = create(:boutique_subscription, active_until: now - 7.days + 1.hour, recurrent: true)
    cancelled = create(:boutique_subscription, active_until: now - 7.days + 1.hour, recurrent: false)
    too_old = create(:boutique_subscription, active_until: now - 8.days, recurrent: true)
    too_fresh = create(:boutique_subscription, active_until: now - 6.day, recurrent: true)
  ...
  test "subscriptions_unpaid - skip emails if there are newer subscription" do
    active_until = now - 7.days + 1.hour

    target_with_newer_sub = create(:boutique_subscription, active_until:, recurrent: true)
    newer_sub = create(:boutique_subscription, boutique_product_variant_id: target_with_newer_sub.boutique_product_variant_id,
                                               ...
                                               recurrent: true)
    # 1
    target_without_newer_sub = create(:boutique_subscription, active_until:, recurrent: true)
    # 2
    target_without_newer_sub_by_user = create(:boutique_subscription, active_until:, recurrent: true)
    ...
    # 3
    target_without_newer_sub_by_product = create(:boutique_subscription, active_until:, recurrent: true)
    ...
    # 4
    target_without_newer_sub_by_time = create(:boutique_subscription, active_until:, recurrent: true)
    newer_sub = create(:boutique_subscription, boutique_product_variant_id: target_with_newer_sub.boutique_product_variant_id,
                                               user: target_with_newer_sub.user,
