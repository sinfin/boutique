...
class Boutique::Orders::CartCell < Boutique::ApplicationCell
  ...
  def form(&block)
    opts = {
      ...
      method: :post,
      html: { class: "b-orders-cart__form" },
    }
  ...
  def email_input(f)
    ...
    f.input :email,
            required: true,
            error: custom_error,
            wrapper_html: { class: "b-orders-cart__email-input" },
  ...
  def addresses_fields_title
    ...
    [
      content_tag(:span, default_title,
                         class: "b-orders-cart__addresses-fields-title b-orders-cart__addresses-fields-title--default",
                         style: ("display: none;" if current_order.gift?)),
      content_tag(:span, t(".addresses_fields_title.gift"),
                         class: "b-orders-cart__addresses-fields-title b-orders-cart__addresses-fields-title--gift",
