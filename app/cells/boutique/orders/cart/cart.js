(() => {
  const refresh = (e) => {
    ...
    $.ajax({
      ...
      data: {
        shipping_method_id: $wrap.find('.b-checkout-cart-shipping-methods__input:checked').val(),
  ...
  $(document)
    ...
    .on('change', '.b-orders-cart .b-checkout-cart-shipping-methods__item-input', refresh)
